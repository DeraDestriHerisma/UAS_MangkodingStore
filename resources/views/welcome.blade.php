...
<body>
  ...
  <div class="max-w-[100%] mx-auto py-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-28 gap-x-10 mt-10">
      ...
      <div class="relative  ">
        <img src="{{ asset('fotoproduk/'.$item->foto) }}" style="width: 65%" class="h-5px w-5px" alt="">
        <div class="mt-3 space-y-4">
          <div class="flex justify-between">
            <p class="font-bold text-md">{{ $item->title }}</p>
          </div>
          <p class="font-bold text-md">{{ $item->harga }}</p>
          <div class="flex justify-between">
            <p class="text-md text-gray-400">{{ $item->deskripsi_product }}</p>
          </div>
          <div class="flex justify-between">
